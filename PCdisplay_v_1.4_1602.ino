...
*/
// ------------------------ НАСТРОЙКИ ----------------------------
// настройки wifi, пределов скорости и температуры по умолчанию (на случай отсутствия связи)
...
#define SSID_WIFI "ssid"      // сюда вписываете навзание вашего Wi-Fi
#define PASSWORD "pass"       // здесь пароль от Wi-Fi
#define IP_ADRESS "ip"        // ip-адрес веб-сервера (берёте в программе)
#define PORT "port"
// ------------------------ НАСТРОЙКИ ----------------------------
...
//#include <ESP8266WiFi.h>        // библиотека wifi
//#include <ESP8266HTTPClient.h>  // библиотека http-клиента
// -------------------- БИБЛИОТЕКИ ---------------------
...
//{
//  WiFiClient client;
//  if(!client.connect("IP_ADRESS","PORT"))
//    {
